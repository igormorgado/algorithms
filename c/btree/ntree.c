...
int main(void) {
  ...
  */
  ...
  nNode_traverse_levelOrder(root, TRAVERSE_ALL, (nNodeTraverseFunc)nNode_print, 0);
  printf("\n");   
  nNode_traverse_levelOrder(root, TRAVERSE_LEAVES, (nNodeTraverseFunc) nNode_print, 0);
  printf("\n");   
